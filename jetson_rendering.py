...
#	flag=0
	...
	client_socket.connect(("192.168.0.8",8702))
...
#		print('Average max-Q = {}'.format(sum(avg_q_max_data)/len(avg_q_max_data)))
	...
	if len(ts)>100:
		...
		f=open('power.csv','w',encoding='utf-8',newline='')
		wr=csv.writer(f)
		...
		f=open('clock.csv','w',encoding='utf-8',newline='')
		wr=csv.writer(f)
		...
		f=open('fps.csv','w',encoding='utf-8',newline='')
		wr=csv.writer(f)
